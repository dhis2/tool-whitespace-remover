	...
	function checkConflictsSummary(type, id, conflictsSummary, $selectedRows) {
	    ...
	    $selectedRows.each(function () {
	        if ($(this).data('id') !== id) {
	            ...
	            // Encode field values to sanitize them
	            var encodedOtherName = encodeURIComponent(otherName);
	            var encodedOtherShortName = encodeURIComponent(otherShortName);
	            var encodedOtherCode = encodeURIComponent(otherCode);
